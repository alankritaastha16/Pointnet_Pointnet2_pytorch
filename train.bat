...
echo "train_partseg_ponderNethidden_only_trainitr.py PonderNethidden_part_seg_ssg"
python train_partseg_ponderNethidden_only_trainitr.py --model PonderNethidden_part_seg_ssg --log_dir PonderNethidden_part_seg_ssg_only_train_iterations --epoch 100 --num_itr 1  --datadir "C:\Users\alank\OneDrive - TUM\Master Thesis\Algorithms\data"
echo "train_semseg_ponderNethidden_only_trainitr.py PonderNethidden_sem_seg"
python train_semseg_ponderNethidden_only_trainitr.py --model PonderNethidden_sem_seg --log_dir PonderNethidden_sem_seg_only_train_iterations --epoch 51 --num_itr 1 --datadir "C:\Users\alank\OneDrive - TUM\Master Thesis\Algorithms\data"
