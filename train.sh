...
srun python3 train_semseg_ponderNethidden_only_trainitr.py --model PonderNethidden_sem_seg --log_dir PonderNethidden_sem_seg_only_train_iterations --epoch 51 --num_itr 1